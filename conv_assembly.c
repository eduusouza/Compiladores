...
int contaQtdParametros = 0, argumentoAtual = 0, contaQtdArgumento = 0;
static int linhaAtual = 1, qtdFunc = 0;
...
int buscaValorEnderecoRegistrador(char *regAux)
{ // retorna o número do registrador no processador
